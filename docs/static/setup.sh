...
options=("Kyria" "Lily58" "Corne" "Splitreus62" "Sofle" "Iris" "Reviung41" "RoMac" "RoMac+" "makerdiary M60" "Microdox" "TG4X" "QAZ" "NIBBLE" "Jorne" "Jian" "CRBN" "Tidbit" "Eek!" "BF0-9000" "Helix" "Rebound_v4")
...
select opt in "${options[@]}" "Quit"; do
    ...
    22 ) shield_title="Rebound_v4" shield="rebound_v4"; split"n"; break;;
