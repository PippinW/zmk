...
Security
Insights
zmk/docs/static/setup.ps1
@pbz
pbz feat(shields): add bfo9000 shield
…
Latest commit dcd6659 yesterday
 History
 11 contributors
@petejohanson@CrossR@krikun98@careyk007@MangoIV@ReFil@Nicell@jaygreco@pbz@BrainWart@innovaker
206 lines (159 sloc)  6.46 KB
...
# TODO: Add support for "Other" and linking to docs on adding custom shields in user config repos.
$options = "Kyria", "Lily58", "Corne", "Splitreus62", "Sofle", "Iris", "Rebound", "Reviung41", "RoMac", "RoMac+", "makerdiary M60", "Microdox", "TG4X", "QAZ", "NIBBLE", "Jorne", "Jian", "CRBN", "Tidbit", "Eek!", "BFO-9000"
$names = "kyria", "lily58", "corne", "splitreus62", "sofle", "iris","rebound4", "reviung41", "romac", "romac_plus", "m60", "microdox", "tg4x", "qaz", "nibble", "jorne", "jian", "crbn", "tidbit", "eek", "bfo9000"
$splits = "y", "y", "y", "y", "y", "y", "n", "n", "n", "n", "n", "y", "n", "n", "n", "y", "y", "n", "n", "n", "n"
